...
from app.services.pagination import pagination_query
...
class TagRepository:
    ...
    def list_tags(
        ...
        # convierte el objeto de orm a un modelo de pydantic
    ...
    def most_popular(self) -> dict:
        row = (
            self.db.execute(
                ...
                .group_by(PostORM.id, TagORM.name)
